...
execute as @e[type=!#goldark:magic_immune, tag=!goldark.perks.holy_immune, tag=!goldark.holy_sickness.active, distance=..3] unless predicate goldark:entity/has_purity_effect run tag @s add goldark.holy_sickness.active_judgement
execute as @e[type=!#goldark:magic_immune, tag=!goldark.perks.holy_immune, tag=!goldark.holy_sickness.active, distance=..3] unless predicate goldark:entity/has_purity_effect run tag @s add goldark.holy_sickness.active

# Add Holy Sickness score
scoreboard players add @e[type=!#goldark:magic_immune, tag=goldark.holy_sickness.active, distance=..3] goldark.effect_timer.holy_sickness 4

# Add MORE Holy Sickness score to Undead
scoreboard players set @e[type=#undead, tag=goldark.holy_sickness.active, scores={ goldark.effect_timer.holy_sickness=..1000 }, distance=..3] goldark.effect_timer.holy_sickness 1200
scoreboard players add @e[type=#undead, tag=goldark.holy_sickness.active, distance=..3] goldark.effect_timer.holy_sickness 8
