...
# Remove Purity tag once effect wears off
execute as @a[tag=goldark.effects.purity] unless predicate goldark:entity/has_purity_effect run tag @s remove goldark.effects.purity