...
## * 
## * Last modified: January 19th, 2025 (AydenTFoxx)
...
execute if entity @s[type=!player] run tp @s @n[type=wolf, tag=goldark.dummy_morph.werewoof, distance=..4]
...
execute unless entity @n[type=wolf, tag=goldark.dummy_morph.werewoof, distance=..4] run function goldark:paths/werewoof/morph/revert