...
execute if entity @n[type=!#undead, type=!#frog_food, tag=goldark.temp.take_blood, distance=..6] \
        unless entity @s[advancements={ goldark:paths/vempyre/take_blood/entity_humanoid=true }] \
        run playsound entity.generic.burn player @s ~ ~ ~ 0.6 0.8

execute if entity @n[type=!#undead, type=!#frog_food, tag=goldark.temp.take_blood, distance=..6] \
        if entity @s[advancements={ goldark:paths/vempyre/take_blood/entity_humanoid=true }] \
...
advancement revoke @s only goldark:paths/vempyre/take_blood/entity_humanoid
