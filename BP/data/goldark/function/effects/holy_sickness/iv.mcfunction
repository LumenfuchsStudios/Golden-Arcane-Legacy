...
# This must end
title @s[tag=goldark.holy_sickness.active, tag=!goldark.holy_sickness.pure_block, scores={ goldark.effect_timer.holy_sickness=..2500 }] actionbar { "text": "All things are in pain; You must be rid of what you hold dear.", "color": "gold", "bold": true }
title @s[tag=goldark.holy_sickness.active, tag=goldark.holy_sickness.pure_block, scores={ goldark.effect_timer.holy_sickness=..2500 }] actionbar { "text": "Everything is in pain; You must leave or you will be gone.", "color": "gold", "bold": true }
