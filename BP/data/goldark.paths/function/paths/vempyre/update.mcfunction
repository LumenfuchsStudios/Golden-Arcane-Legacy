...
## * 
## * Last modified: January 26th, 2024 (AydenTFoxx)
...
execute if predicate goldark:player_input/sprint if predicate goldark:player_input/backward \
        unless entity @s[tag=goldark.path_transformed] unless score @s goldark.health_check matches ..1 \
...
# Update Bat form
execute if entity @s[tag=goldark.path_transformed, tag=!goldark.dummy_morph.vempyre] run function goldark.paths:paths/vempyre/morph/update