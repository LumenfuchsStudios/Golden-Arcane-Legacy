...
## LEVEL I: The Warning
execute if score @s goldark.effect_timer.holy_sickness matches ..1200 run function goldark.paths:effects/holy_sickness/i

## LEVEL II: The First Signs
execute if score @s goldark.effect_timer.holy_sickness matches 500..2100 run function goldark.paths:effects/holy_sickness/ii

## LEVEL III: Shit Got BAD
execute if score @s goldark.effect_timer.holy_sickness matches 1200..2000 run function goldark.paths:effects/holy_sickness/iii
execute if score @s goldark.effect_timer.holy_sickness matches 2100.. run function goldark.paths:effects/holy_sickness/iii
...
execute if score @s goldark.effect_timer.holy_sickness matches 2100.. \
        ...
        run function goldark.paths:effects/holy_sickness/iv

## LEVEL V: By Your Will
execute if score @s goldark.effect_timer.holy_sickness matches 2750.. \
        unless score @s goldark.effect_timer.holy_numbness matches 1.. \
        run function goldark.paths:effects/holy_sickness/v
