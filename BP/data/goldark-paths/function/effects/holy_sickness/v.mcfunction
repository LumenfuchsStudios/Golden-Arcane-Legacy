...
execute if score @s goldark.effect_timer.holy_sickness matches 3200..4200 as @e[distance=..2] run damage @s 4 magic by @s


# The end and beyond
execute if score @s goldark.effect_timer.holy_sickness matches 4444.. run function goldark-paths:effects/holy_sickness/purity