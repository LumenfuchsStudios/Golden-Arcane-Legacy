...
# Run effect
execute as @e[type=!#goldark:magic_immune, scores={ goldark.effect_timer.holy_sickness=1.. }] at @s if loaded ~ ~ ~ run function goldark-paths:effects/holy_sickness/tick
...
# Run effect
execute as @e[type=!#goldark:magic_immune, scores={ goldark.effect_timer.holy_numbness=1.. }] at @s if loaded ~ ~ ~ run function goldark-paths:effects/holy_numbness/tick
...
# Run effect
execute as @e[type=!#goldark:magic_immune, scores={ goldark.effect_timer.holy_numbness=1.. }, tag=goldark.effects.purity] at @s if loaded ~ ~ ~ run function goldark-paths:effects/purity/tick
...
execute as @a[scores={ goldark.death_count=1 }, nbt={ Health: 0.0f }, tag=goldark.perks.werewoof] run function goldark-paths:perks/werewoof
execute as @a[scores={ goldark.death_count=1 }, nbt={ Health: 0.0f }, tag=goldark.perks.vempyre] run function goldark-paths:perks/vempyre
