...
# Tick Dummies
execute as @e[type=marker, tag=goldark.dummy_magic.judgement_trigger] at @s if loaded ~ ~ ~ run function goldark.magic:spells/judgement/tick_trigger
execute as @e[type=marker, tag=goldark.dummy_spell.judgement] at @s if loaded ~ ~ ~ run function goldark.magic:spells/judgement/tick_aura
...
execute as @a[scores={ goldark.used_item.egg=1.. }] at @s if loaded ~ ~ ~ positioned ~ ~1 ~ run function goldark.magic:spells/thunder_egg/init_projectile
...
# Tick Dummies
execute as @e[type=#goldark:technical, tag=goldark.dummy_magic.thunder_egg] at @s if loaded ~ ~ ~ run function goldark.magic:spells/thunder_egg/tick_projectile
execute as @e[type=#goldark:technical, tag=goldark.dummy_spell.thunder_egg] at @s if loaded ~ ~ ~ run function goldark.magic:spells/thunder_egg/tick_storm
